...
special case of the SC's generalisation step, (b)~give a mechanised roundtrip
theorem (Theorem~\ref{thm:roundtrip}), and (c)~integrate it into the three-layer
SC loop with proof-theoretic justification.
...
paradigm~\cite{TODO} than to neural theorem proving.
