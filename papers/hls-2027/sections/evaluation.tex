...
The scrambling experiment uses 6 distinct programs (24 total tests).
The 6/6 success rate refutes the hypothesis that name recognition
\emph{alone} explains the results, but this is not a statistical
evaluation.  A larger corpus, controlled failure cases, and comparison
with prior HLS heuristics (Supero, Bolingbroke) would strengthen the
evidence.  The LLM's self-reported confidence is not independently
validated; the sub-SC pass/fail is the ground-truth signal.
