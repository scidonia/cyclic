...
The 6/6 success rate shows the LLM succeeds even with all function
and type names randomised, and that providing definitions restores
confidence in all cases.  A larger corpus would strengthen the
evidence; the current results demonstrate the architecture is sound
and the LLM can reason from term structure rather than name recognition.
