...
\item \textbf{Mechanised $\omega$-rule} (Section~\ref{sec:limits}).
  ...
  reverse-append distribution.  The lemmas are currently hand-supplied
  in the Rocq tests; the LLM proposal step works in Python; wiring
  them through the OCaml extraction is the remaining engineering step.
