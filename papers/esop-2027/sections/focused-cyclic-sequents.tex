...
\begin{center}
\AxiomC{$\Gamma \vdash b_0 : C[0\,]/]$}
\AxiomC{$\cdots$}
\AxiomC{$\Gamma \vdash b_{n-1} : C[(n{-}1)\,/]$}
\TrinaryInfC{$\Gamma, x : I \vdash \langle x \mid \vec{b} \rangle^I_C : C[x/]$}
\DisplayProof
...
\input{sections/cyclic-proof-diagram}
