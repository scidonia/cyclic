...
\BinaryInfC{$\Gamma, l:\mathsf{List} \vdash \mathsf{case}~l~\mathsf{of}~\{\mathit{nil}\to 0; \mathit{cons}\to\ldots\} : \Nat$}
\RightLabel{\;\fontsize{6}{7}\selectfont\textcolor{red!70}{\textsc{split} $\star$}}
\UnaryInfC{$\Gamma \vdash \mathsf{case}~l~\mathsf{of}~\{\mathit{nil}\to 0; \mathit{cons}\to\ldots\} : \Nat$}
\RightLabel{\;\fontsize{6}{7}\selectfont\textsc{comm}}
\UnaryInfC{$\Gamma \vdash \mathsf{len}\,(\mathsf{case}~l~\mathsf{of}\ldots) : \Nat$}
