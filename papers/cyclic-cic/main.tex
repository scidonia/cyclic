...
We then outline (i) the source term calculus, (ii) a fix-free cyclic proof/term language with explicit substitution evidence, (iii) the global condition on cycles, and (iv) the use of \emph{supercompilation} as a normalization procedure.
\end{abstract}
