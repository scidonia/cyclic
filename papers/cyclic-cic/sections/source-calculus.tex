...
\inferrule*[right=TyVar]
  {\ctx(x)=A}
  {\hastype{\env}{\ctx}{\Var{x}}{A}}

\inferrule*[right=TySort]
  {}
  {\hastype{\env}{\ctx}{\Sort{i}}{\Sort{i+1}}}

\inferrule*[right=TyPi]
  {\hastype{\env}{\ctx}{A}{\Sort{i}}\\
...
\inferrule*[right=TyApp]
  {\hastype{\env}{\ctx}{t}{\PiTy{A}{B}}\\
   \hastype{\env}{\ctx}{u}{A}}
  {\hastype{\env}{\ctx}{\App{t}{u}}{B[u/0]}}

\inferrule*[right=TyFix]
  {\hastype{\env}{\ctx}{A}{\Sort{i}}\\
...
Key rules include:
\begin{mathpar}
\inferrule*[right=Step\_Beta]
  {}
  {\App{(\Lam{A}{t})}{u} \step t[u/0]}

\inferrule*[right=Step\_App1]
  {t \step t'}
  {\App{t}{u} \step \App{t'}{u}}

\inferrule*[right=Step\_Fix]
  {}
  {\Fix{A}{t} \step t[\Fix{A}{t}/0]}

\inferrule*[right=Step\_CaseScrut]
  {t \step t'}
  {\Case{I}{t}{C}{\overline{\mathit{br}}} \step \Case{I}{t'}{C}{\overline{\mathit{br}}}}

\inferrule*[right=Step\_CaseRoll]
  {\mathit{branch}(\overline{\mathit{br}},c)=\mathit{br}}
