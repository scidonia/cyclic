...
\item a CIU preservation statement for the \textsc{CaseCase} commuting conversion (Theorem~\ref{thm:casecase-ciu}); the corresponding Coq lemma is currently \texttt{Admitted} (see \texttt{theories/Transform/CaseCase.v}).
\end{itemize}
