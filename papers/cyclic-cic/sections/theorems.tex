...
This corresponds to the Coq theorem \texttt{ciu\_jTy\_commute\_case\_case\_once}.
The theorem statement and proof infrastructure are in place, including the key lemma \texttt{terminates\_to\_commute\_branch\_typed} (proved).
The main theorem currently has an \texttt{Admitted} placeholder; completing it requires detailed reasoning about substitution and nested case reduction (see \texttt{theories/Transform/CaseCase.v} for the proof strategy).
