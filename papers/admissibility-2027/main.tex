...
\noindent \textbf{Supercompiler corollary.}
In the specific case where $b$ is produced by
$\texttt{supercompile\_jTy\_tc}(\mathit{fuel\_sc},\Sigma,\Gamma,t,A)
= \mathsf{Some}(v,b)$, the well-formedness and trace condition are
discharged automatically (\texttt{cfg\_builder\_well\_formed},
\texttt{trace\_condition\_ok}), giving the corollary
\texttt{backlink\_admissible} in \texttt{BacklinkAdmissible.v}.
